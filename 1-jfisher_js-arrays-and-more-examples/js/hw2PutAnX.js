...
putAnXBtn.onclick = function(){
  ...
  var width = theBox.clientWidth;  //600
  var height = theBox.clientHeight; //400
  console.log(width);
  console.log(height);
        /*
         ...
         *   */      
  var yPosition = Math.floor((Math.random() * 200) + 1);
  console.log(yPosition);
  var xPosition = Math.floor((Math.random() * 300) + 1);
