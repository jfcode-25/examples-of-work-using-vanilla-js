...
pwd1.onblur = function() {
  if (document.getElementById("pwd1").value.length < 8) { 
    document.getElementById("pwd1").classList.add('invalid');
...
pwd2.onkeyup = function() {
    ...
    document.getElementById('pwd2').value) 
  {
    ...
    document.getElementById('pwdCheck').innerHTML = 'Your password entries match.';
    console.log("hello pww2 check");
  } else {
    document.getElementById('pwdCheck').style.color = 'red';
    document.getElementById('pwdCheck').innerHTML = 'Your password entries do not match. Please try again.';
  }
}
...
var selectList = {
  ...
  var selectList2 = {"apparel": ["silk", "wool", "rayon blend", "cotton", "knits"]};
  console.log(fabrics);
